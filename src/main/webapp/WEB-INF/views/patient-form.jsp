        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <form:form action="savePatient" cssClass="form-horizontal"
                    ...
                    <div class="form-group">
                        <label for="email" class="col-md-3 control-label"><spring:message code="patient.email"/></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        <label for="discharged" class="custom-control-label col-md-3 control-label"><spring:message code="patient.discharged"/></label>
                    ...
                    <div class="form-group">
                        <label for="dateStart" class="col-md-3 control-label"><spring:message code="patient.date_start"/></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <form:input path="dateFinish" cssClass="form-control" data-provide="datepicker"/>
                        </div>
                    </div>
